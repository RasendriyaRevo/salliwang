...
<div id="About">
    <div class="container atas">
        <div class="row">
            <div class="col-lg-4">
                <img class="img-circle" src="img/fast.jpg">
            ...
            <div class="col-lg-4">
                <img class="img-circle" src="img/quality.jpg">
            ...
            <div class="col-lg-4">
                <img class="img-circle" src="img/professional.jpg">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row partner">
                        <div class="col-xs-2 col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/inewstv.jpg"></div></a>
                        <div class="col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/vik.jpg"></div></a>
                        <div class="col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/jne.jpg"></div></a>
                        <div class="col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/sequislife.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/allianz.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/tereos_fks.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/iitc_solution.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/ca2con.jpg"></div></a>
                    </div>
                </div>
                
                <div class="carousel-item">
                    <div class="row partner">
                        <div class="col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/j_t.jpg"></div></a>
                        <div class="col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/tokio_marine.jpg"></div></a>
                        <div class="col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/hora.jpg"></div></a>
                        <div class="col-lg-3 atas"><a href="#"><img class="img-responsive" src="img/partner/squeeze.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/bsp.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/nutify.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/logo_jeunesse.jpg"></div></a>
                        <div class="col-lg-3 bawah"><a href="#"><img class="img-responsive" src="img/partner/you.jpg"></div></a>
                    </div>
                </div>
            </div>
        </div>
